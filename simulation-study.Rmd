...
Z(exposure) | binary | $Z=I(Y*>0)$ where $Z*\sim U_0+U_1X+N(0, 1)$
...
Coefficient values used(Only positive effects. Maybe test with negatives?):
...
ggplot() + 
  ...
  xlab('correlation.coef') +
  ylab('coverage') +
  ggtitle("Coverage of nominal 95% CI. Nominal=baserat på delta-SE?") 
ggplot() + 
